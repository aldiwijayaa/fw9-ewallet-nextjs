  ...
  return (
    <>
      ...
      <section className="about">
        ...
        <div>
          ...
          <div className="container">
            ...
            <h3>Easy Download</h3>
            <p>Ewallet is 100% totally free to use it's now available on Google Play Store and App Store.</p>
          </div>
        </div>
      </section>
      ...
      <section className="features">
        ...
        <div>
          <h1>
            All The <span>Great</span> Ewallet Features.
          </h1>
          <div className="container">
            <div>
              <span>1.</span>
          ...
          <div className="container">
            ...
            <p>Ewallet come up with modern and sleek design and not complicated.</p>
          </div>
        </div>
      </section>
